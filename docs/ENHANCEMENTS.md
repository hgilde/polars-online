...
Status as of 2026-09-03: **every task in `docs/PLAN.md` §11 bar 18 and every
enhancement below are complete, bar E28/E29, which are recorded decisions
not to.** Ten models (`ewridge`, `rls`, `lasso`,
