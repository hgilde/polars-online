...
| 6. Expression ≡ bank | Done for every model, incl. grids and `.over()`. Since 2026-09-03 the expression plugin is dormant (PLAN §6): these tests run in a `--features expr-plugin` build and skip, with the reason, in the default one. |
