...
def _common(
    ...
    *,
    ...
    min_session_clock: float | None = None,
    backwards_jitter_ratio: float | None = None,
    ...
    spec = {
        ...
        "min_session_clock": min_session_clock,
        "backwards_jitter_ratio": backwards_jitter_ratio,
        "session": session,
